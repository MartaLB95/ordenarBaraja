...
public class OrdPalNumInc extends AlgoritmoOrdenacion{
	...
	//Comparación primero por palo
		...
		//Comparamos después por número de forma incremental
		return Integer.compare(ValorCarta.valorCartas.get(c1.getNumero()), ValorCarta.valorCartas.get(c2.getNumero()));
	 }	
	 }
}
