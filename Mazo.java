...
public class Mazo {
	    ...
	    public void ordena() {
	        // Le pide al algoritmo que ordene
	    	  if (algoritmo != null) {  // Asegurarse de que hay un algoritmo seleccionado
	    	        algoritmo.ordena(cartas);  // Ordenar las cartas con el algoritmo seleccionado
	    	    } else {
	    	        System.out.println("No se ha establecido un algoritmo de ordenación.");
	    	    }
	    }
